                  ...
                  <div class="col-md-12">
                    <div class="">
                      <div class="">
                        ...
                        $query = "SELECT adopter.firstname, adopter.lastname, transaction.*
                                  FROM transaction
                                  LEFT JOIN adopter ON transaction.adopter=adopter.email";
                                ...
                                <table id="donationTable" class="table table-light table-hover table-striped table-md">
                                  <thead>
                                    <tr>
                                      ...
                                      <th scope="col" class="th-sm">REFERENCE</th>
