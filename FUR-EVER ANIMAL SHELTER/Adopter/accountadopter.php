...
<head>
    ...
    <title>Account | Fur-Ever Animal Shelter</title>
            ...
            <section class="module">
                <div class="module-inner">
                    ...
                    <div class="content-panel">
                        ...
                        <form class="form-horizontal" method="POST" action="function.php" enctype="multipart/form-data" autocomplete="off">
                            <fieldset class="fieldset">
                                <h3 class="fieldset-title">Personal Info</h3>
                                <div class="form-group avatar">
                                    <figure class="figure col-md-1 col-sm-1 col-md-1 col-xs-1">
                                        <img class="img-profile rounded-circle img-responsive center-block" src="<?php echo "../profileimg/" . $image; ?>" alt="">
                                    </figure>
                                    <div class="form-inline col-md-12 col-sm-12 col-md-12 col-xs-12">
                                        <?php echo "<input type='file' name='image' class='file-upload-default' value='$image'>" ?>
                                        <br><br><br>
                                    </div>
                                </div>
