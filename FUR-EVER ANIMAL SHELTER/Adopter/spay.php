...
<head>
  ...
  <title>Spay | Fur-Ever Animal Shelter</title>
    ...
    <div class="container">
      <div class="row gy-4">
        ...
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="assets/img/doctor.png" class="" alt="">
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p class="description">Spaying/neutering cats </p>
			  <p>RM120</P>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-dollar-circle"></i></div>
              <p class="description">Spaying/neutering dogs </p>
			  <p>RM180</P>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-dollar-circle"></i></div>
              <p class="description">Vaccination for cat & dog </p>
			  <p>RM50</P>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-dollar-circle"></i></div>
              <p class="description">Deworming for cat & dog </p>
			  <p>RM5</P>
            </div>
          </div>
        </div>
