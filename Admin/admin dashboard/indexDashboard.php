    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/samples/accountadmin.php">
          ...
          <div class="row" id="proBanner">
            <div class="col-12">
              <span class="d-flex align-items-center purchase-popup">
                <p>Someone has adopted a fur buddy from Fur-Ever Animal Shelter!</p>
                <a href="pages/samples/adopter-history.php" target="_blank" class="btn download-button purchase-button ml-auto">Check</a>
          ...
          <div class="row">
            <div class="col-md-7 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="clearfix">
                    <h4 class="card-title float-left">Animal Adoption Statistics</h4>
