...
<head>
  ...
  <title>Rehoming | Fur-Ever Animal Shelter</title>
    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Shelter, Rehabilitation & Rehoming.</h1>
          <h2 class="text-dark">There’s a fur-ever friend waiting for you with our adoption program. With FAS, we ensure that all animals are assessed for what it needs to be the happiest, healthiest pet.</h2>
          <div>
            <a href="index.php" class="btn-get-started scrollto"><b>HOME</b></a>
          </div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img">
          <img src="assets/img/home.png" class="" alt="">
        </div>
      </div>
    </div>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <p>Why Adopt With Us?</p>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-spa"></i></div>
              <p class="description">We will ensure our animals are adopted by trusted people who have suitable homes and are financally stable for keeping pets </p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-spa"></i></div>
              <p class="description">We make sure to give occasional medical treatments to our pets before they're adopted</p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-spa"></i></div>
              <p class="description">Our organization is trusted and reliable; as we are recognized nationwide by the approval of the government </p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              <div class="icon"><i class="bx bx-spa"></i></div>
              <p class="description">Our shelter consists of loving, responsible, committed and patient animal lovers as our staffs </p>
            </div>
          </div>
        </div>
