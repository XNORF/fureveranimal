        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">
                ...
                <div>
                  <img src="assets/img/portfolio/dog12.jpg"  alt="" width="800" height="800" >
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Name</strong>: Marius</li>
                <li><strong>Age</strong>: 2.3 Years</li>
                <li><strong>Gender</strong>: Male</li>
				<li><strong>Health Condition(s)</strong>: Disfunction legs</li>
            ...
            <div class="portfolio-description">
              ...
              <h2>Story of Marius's life</h2>
              <p>
                He was a stray dog. He got rescued because he was got hit by a car. Someone brought him to vet and drop him to us to get a good care.
              </p>
			  <br>
			  <br>
			   <div class="container">
