    ...
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <div>
            <a href="admin dashboard/indexDashboard.php" class="btn-get-started scrollto"><b>DASHBOARD</b></a>
			<a href="adopt.php" class="btn-get-started scrollto"><b>ADOPT</b></a>
			<a href="donation/donation.php" class="btn-get-started scrollto"><b>DONATE</b></a>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <p class="description">We will strive to ﬁnd the best animal-and-human match for you and your new pet</p>
            </div>
          </div>
