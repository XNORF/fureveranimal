        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">
                ...
                <div>
                  <img src="assets/img/portfolio/dog2.jpg" alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Name</strong>: King</li>
                <li><strong>Age</strong>: 10 Months</li>
                <li><strong>Gender</strong>: Male</li>
				<li><strong>Health Condition(s)</strong>: Left leg a little weak</li>
            ...
            <div class="portfolio-description">
              ...
              <h2>Story of King's life</h2>
              <p>
                King was abused by its previous owner and luckily, someone reported the case to the authorities. FAS managed to rescue King in time. King is a couch potato and it is a curious dog too.
              </p>
			  <br>
			  <br>
			   <div class="container">
