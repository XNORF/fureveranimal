        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">
                ...
                <div>
                  <img src="assets/img/portfolio/cat8.jpg"  alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Name</strong>: Killa</li>
                <li><strong>Age</strong>: 1.3 Year</li>
            ...
            <div class="portfolio-description">
              ...
              <h2>Story of Killa's life</h2>
              <p>
                She was found in an abandoned tree house on the edge of the forest. She was pregnant in that time, so we also saved her kittens too. After two weeks, she getting more cheerful and active.
              </p>
			  <br>
			  <br>
			   <div class="container">
