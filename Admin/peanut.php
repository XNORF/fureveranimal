        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Name</strong>: Peanut</li>
            ...
            <div class="portfolio-description">
              ...
              <h2>Story of Peanut's life</h2>
              <p>
                Peanut was given up by its previous owner due to their busy work life. Peanut is usually calm but can be aggressive when it's being playful.
              </p>
			  <br>
			  <br>
			   <div class="container">
