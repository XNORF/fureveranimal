        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">
                ...
                <div>
                  <img src="assets/img/portfolio/dog6.jpg"  alt="">
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Name</strong>: Wolfie</li>
                <li><strong>Age</strong>: 4 Years</li>
                <li><strong>Gender</strong>: Male</li>
				<li><strong>Health Condition(s)</strong>: Deaf</li>
            ...
            <div class="portfolio-description">
              ...
              <h2>Story of Wolfie's life</h2>
              <p>
                He was found in the roadside, almost got hit by a car because he is deaf. The one that save him brought him to us to get a proper care and also to prevent him from wandering alone in the big road.
              </p>
			  <br>
			  <br>
			   <div class="container">
