                ...
                <div class="side-bar">
            		...
            		<nav class="side-menu">
        				<ul class="nav">
        					...
        					<li><a href="adoptionhistoryadmin.php"><span class="fa fa-envelope"></span> Adoption History</a></li>
        					...
        					<!--<li><a href="changepassadminTest.php.php"><span class="fa fa-th"></span> Change Password</a></li>-->
        				</ul>
        			</nav>
                </div>
