        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            <div class="portfolio-details-slider swiper-container">
              <div class="swiper-wrapper align-items-center">
                ...
                <div>
                  <img src="assets/img/portfolio/dog11.jpg"  alt="" width="800" height="800" >
                </div>
          ...
          <div class="col-lg-4">
            <div class="portfolio-info">
              ...
              <ul>
                <li><strong>Name</strong>: Fraiser</li>
                <li><strong>Age</strong>: 5 Years</li>
                <li><strong>Gender</strong>: Male</li>
				<li><strong>Health Condition(s)</strong>: Old</li>
            ...
            <div class="portfolio-description">
              ...
              <h2>Story of Fraiser's life</h2>
              <p>
               Found him when he was 4 years old at the abandoned neighbourhood. Because of his looks and lovely nature, everyone even the vet thought he was a Golden Retriever mix. His legacy may well be that, because he was such a nice dog.
              </p>
			  <br>
			  <br>
			   <div class="container">
